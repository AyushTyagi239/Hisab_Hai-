...
export default defineSchema({
  users: defineTable({
    ...
    email: v.optional(v.string()),  // Changed to optional
    tokenIdentifier: v.string(),
    imageUrl: v.optional(v.string()),
  })
  .index("by_token", ["tokenIdentifier"])
  .index("by_email", ["email"])    // Still works with optional fields
  .searchIndex("search_name", { searchField: "name" })
  .searchIndex("search_email", { searchField: "email" }), // Works with
